...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "UnityNativeUtils",
            url: "https://yw-depot-nexus.100bt.com/repository/onesdk-ios-trunk/spm/UnityNativeUtils/1.10.7-dev-1406382/UnityNativeUtils.xcframework.zip",
            checksum: "187439f8bb635dd2db464b263c70353eaed94387a645bbfcbad06114d7603143"
        )
    ]
)
